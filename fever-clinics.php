...
<head>
    ...
    <meta name="description" content="List of BBMP fever clinics around you. If you have covid symptoms or want to get covid tests for free, visit fever clinics">
    <meta name="keywords" content="covid, coronavirus, covid19, BBMP fever clinics, covid testing, covid symptoms">
    ...
    <!-- Site Metas -->
    <title>BBMP Fever Clinics</title>
    <!-- Site Icons -->
...
<div id="fever_clinic" class="container">
    <div class="heading">
        <h2 style="font-weight: bold; background-color: white; padding-top: 20px">BBMP Fever Clinics</h2>
    </div>
    <div class="row">
    <div class="col-md-12">
